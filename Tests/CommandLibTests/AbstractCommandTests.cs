...
namespace Tests.CommandLibTests
{
    public class AbstractCommandTest
    {
        ...
        public void Setup()
        {
            ...
            _command = new MessageCommand(Encoding.UTF8.GetBytes(Str), _keys[1]);
        }
        ...
        public void ByteArrayAbstractCommand()
        {
            ...
            Assert.AreEqual(Str, Encoding.UTF8.GetString(command.Data));
        }
        ...
        public void TransferCommandTest()
        {
            ...
            var datagram = new Datagram(command.ToBytes(), typeof(TransferCommand), _keys[1]);
        ...
        public void ShutdownCommandTest()
        {
            ...
            var datagram = new Datagram(command.ToBytes(), typeof(ShutdownCommand), _keys[1]);
            var bytes = datagram.ToBytes();
            datagram = Datagram.FromBytes(bytes);
            var newCommand = AbstractCommand.FromBytes(datagram.GetData(_keys[0]), datagram.Type);
